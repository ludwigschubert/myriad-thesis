...
\lstset{
  ...
  emphstyle={
          \bfseries\color{orange}\bfseries
       }
}
...
% Nicer Tables as per http://www.inf.ethz.ch/personal/markusp/teaching/guides/guide-tables.pdf
\usepackage{booktabs}
...
% ngerman is Neue Rechtschreibung, which is important for hyphenation, e.g. Bä-cker vs Bäk-ker
% other choices include english and american
\usepackage[american]{babel}
\selectlanguage{american}

% Use UTF8. Anything else is a crime nowadays*. * This is 2013
