...
\fbox{\parbox{\textwidth}{
  \begin{enumerate}
    ...
    \item Login with OAuth
    \item Create Campaign
    \item Create Template
    \begin{enumerate}
      \item Insert Placeholders
    \end{enumerate}
    \item Send Emails
    \begin{enumerate}
      \item Reuse Template
      \item Parse list of Contacts from To: field
      \item Prevent same Template being sent twice
    \end{enumerate}
    \item Fetch Replys from Gmail
    \item View Emails by Conversation
    \begin{enumerate}
      \item View Conversation State
      \item Reply in Conversation
      \begin{enumerate}
        \item Create Template from Reply
      \end{enumerate}
    \end{enumerate}
  \end{enumerate}
}}

\insertfigure{figures/usecases.pdf}{For readability, transitive ``uses'' edges are assumed implicitly. Also, the user is the actor for all use cases -- only the three nearest have been connected.}{usecases}{1}{Own illustration}
...
\insertfigure{figures/workflow1.pdf}{Continued on next page}{fig:workflow1}{1}{Own illustration with Christian Ikas}
\insertfigure{figures/workflow2.pdf}{}{fig:workflow2}{1}{Own illustration with Christian Ikas}
...
\insertfigure{figures/deployment.pdf}{The Myriad Webserver mediating between Client and Google Services}{fig:deployment}{1.0}{Own illustration}
