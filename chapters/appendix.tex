...
\insertfigure{figures/uml_class_diagram_04.pdf}{By April \nth{18} \code{ValueSettingAction}s and assistant \code{SharingAssignment}s were added. Note how support for importing emails by label necessiated a direct connection from \code{Campaign}s to \code{Email}s which are not associated to any \code{Template}.}{UMLDiagram04}{1}{Own drawing with Christian Ikas}
