...
This thesis is set in \LaTeX \citep{latex}. The template used is based on the official TUM Computer Science template. The sources are under version control by git; hosted publicly on GitHub. The PDF file is built by the continuous integration server Travis.
