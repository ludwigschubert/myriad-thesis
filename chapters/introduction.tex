...
To fullfill this goal, Myriad provides a high level organizational abstraction called \code{Campaigns}, a visualization of individual conversation state and actionability, filtering and actions on groups of results, easy reusability and automation of replies (\code{Messages}), as well as support for delegation to assistants and generally usable integration into existing email and inforation management infrastructure.
